...
Cependant, lors de la configuration de nouvelles machines Windows, la répétition fastidieuse de l'installation manuelle de logiciels est devenue évidente.
